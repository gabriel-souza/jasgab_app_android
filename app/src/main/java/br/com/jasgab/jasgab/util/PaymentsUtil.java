...
public class PaymentsUtil {
     ...
     * environment and theme set in {@link PaymentsConstants}.
     *
    ...
    private static JSONObject getGatewayTokenizationSpecification() throws JSONException {
        return new JSONObject() {{
            ...
            put("parameters", new JSONObject() {{
                put("gateway", "cielo");
                put("gatewayMerchantId", "6d5b6530-836e-4623-a050-ad3353dd4611");
            }});
        }};
    }
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        if (PaymentsConstants.DIRECT_TOKENIZATION_PARAMETERS.isEmpty()
                || PaymentsConstants.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty()
                || PaymentsConstants.DIRECT_TOKENIZATION_PUBLIC_KEY == null
                || PaymentsConstants.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME") {
        ...
        JSONObject parameters = new JSONObject(PaymentsConstants.DIRECT_TOKENIZATION_PARAMETERS);
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", PaymentsConstants.COUNTRY_CODE);
    ...
    private static JSONObject getMerchantInfo() throws JSONException {
        return new JSONObject().put("merchantName", "JASGAB TELECOM");
    }
    ...
    public static Optional<JSONObject> getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(PaymentsConstants.SHIPPING_SUPPORTED_COUNTRIES);
