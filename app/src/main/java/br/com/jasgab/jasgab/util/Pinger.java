...
public class Pinger {
    ...
    public static List<DeviceWifi> getDevicesOnNetwork(String subnet){
        ...
        ArrayList<DeviceWifi> foundDev = new ArrayList<>();

        for (InetAddress a: resAddresses){
            foundDev.add(new DeviceWifi(a.getHostAddress(), getMacFromArpCache(a.getHostAddress()), a.getHostName(), ""));
        }
     ...
     * <br>
     * IP address       HW type     Flags       HW address            Mask     DeviceWifi
